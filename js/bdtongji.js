...
var access_token = '121.25e55e553944444f7b77ff23506a5428.YaSmMcea4a7LXxSZAeVP97Nly0NGaujIykv9Hyn.sKD0Qg' // accessToken
var site_id = '17321284' // 网址 id
var dataUrl = 'https://bai-du-tong-ji-lavender816.vercel.app/api?access_token=' + access_token + '&site_id=' + site_id
...
function trendsChart () {
  ...
  fetch(dataUrl + paramUrl)
    ...
    .then(data => {
      ...
      for (let i = Math.min(monthName.length, 30) - 1; i >= 0; i--) {
        monthArr.push(monthName[i][0].substring(0, 13))
        if (monthValue[i][0] !== '--') {
